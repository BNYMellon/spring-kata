...
public class TodoProductionServiceSwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("todo")
                .select()
                .apis(RequestHandlerSelectors.basePackage("bny.training.spring.boot.todo"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.bny.com/us/en/terms-of-use.jsp")
                .license("BNY License")
                .licenseUrl("https://www.bny.com/us/en/terms-of-use.jsp")
                .version("1.0")
                .build();
    }
