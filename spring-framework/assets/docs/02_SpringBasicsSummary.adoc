...
The framework itself comprises several modules building on a
`spring-core` library.
...
Spring offers support for link:https://jcp.org/en/jsr/detail?id=330[JSR-330,https://jcp.org/en/jsr/detail?id=330] standard annotations (Dependency Injection).
JSR-330 is a
*Java Specification Request* for Dependency Injection standards.
It provides annotations similar to what Spring has for dependency injection.
Spring is compatible with JSR-330 annotations.
